...
// Print whether the printer is out of ink or not
void printInkLevel() {
    // Extract the NO_INK bit using the provided mask
...
// Replace the ink the printer
void replaceInk() {
    // Clear the NO_INK bit to indicate there is ink left
...
void printMode() {
    ...
    // Extract the SELECT_PRINT bit
    if (printerControl & SELECT_PRINT) {
        printf(" Print");
    }

    // Extract the SELECT_SCAN bit
